    ...
    var body: some View {
        RoundedCardScrollView {
            RoundedCard(
                ...
                footer: LocalizedString("A reminder is configured during Pod setup to notify you in advance of Pod expiration. Set the number of hours advance notice you would like to configure by default when pairing a new Pod.", comment: "Footer text for pod reminders section")
            ) {
